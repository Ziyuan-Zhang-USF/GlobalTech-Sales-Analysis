...
# Your code here
top_categories_by_region = sales_df.groupby(['Region', 'Category'])['Total_Sales'].sum().loc[lambda x: x.groupby(level=0).idxmax()]
...
print("\nKEY BUSINESS RECOMMENDATIONS:")
print("1. Increase Promotion Frequency: Promoted items show a significant impact on revenue; expand these to the Latin America region.")
print("2. Focus on Smartphones: The Smartphones category (specifically PhoneX) is the top revenue driver; maintain high inventory levels.")
print("3. Data Integrity Check: Several records in Unit_Price and Units are missing; implement data validation at the store level to ensure 100% reporting accuracy.")